...
export function AppointmentCard({ appointment }: { appointment: Appointment }) {
  ...
  return (
    <article className={cn("rounded-lg border bg-white p-4 shadow-sm", appointment.emergency ? "border-rose-200 ring-4 ring-rose-50" : "border-slate-200")}>
      <div className="flex items-start justify-between gap-3">
        <div>
          <div className="flex flex-wrap items-center gap-2">
            <h3 className="font-semibold text-slate-950">{appointment.patientName}</h3>
