...
const queueActionByStatus: Record<QueueStatus, QueueAction> = {
  ...
  Arrived: {
    ...
    className: "bg-violet-500 text-white hover:bg-violet-600 border-violet-500 hover:border-violet-600",
  },
  "In Consultation": {
    label: "Complete",
      ...
      <div className="border-b border-slate-100 px-4 py-4 dark:border-zinc-800 sm:px-5">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            <SummaryPill label="Pending" value={counts.Pending} tone="sky" />
            <SummaryPill label="Confirmed" value={counts.Confirmed} tone="sky" />
            <SummaryPill label="Arrived" value={counts.Arrived} tone="violet" />
...
function SummaryPill({
  ...
  const toneClass =
    tone === "sky"
      ...
      : tone === "violet"
        ? "bg-violet-50 text-violet-700 ring-violet-200 dark:bg-violet-500/10 dark:text-violet-100 dark:ring-violet-900/50"
